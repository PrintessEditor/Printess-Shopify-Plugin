import { TemplateImportOptions, TemplateImportTask } from "../automation/printess-layout-skill/references/template-import-interfaces"
...
export interface iPrintessApi {
  ...
  */
   ...
   * the value is overwritten and the schema is left alone — pick a unique name per panel.
   *
   * Returns `undefined` on success, or a human-readable error string on failure.
   * #ai-api
   */
  ...
  /**
   * Companion to `writeStateToFormField` — reads and JSON-parses the value back. Returns the
  ...
  */
  ...
  /**
   * Returns true if the simple magic photobook flag is enabled
   */
  restrictToOneImagePerPage(): boolean
  ...
  */
   ...
   */
  insertLayoutSnippet(snippetUrl: string, targetPage?: "left" | "right" | "entire", spread?: any, colorScheme?: string, hideRemoveBorderOption?: boolean, splitVariant?: number, forceRepeat?: ForceSnippetPlacement, layoutImageSelection?: "apply" | "skip", removeBoxesOnBackgroundLayer?: boolean): Promise<void>;
